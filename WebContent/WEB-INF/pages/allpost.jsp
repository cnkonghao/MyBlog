		...
		<div class="topnews">
			...
			<c:forEach items="${data.list}" var="posts">
				...
				<ul>
					...
					<p class="autor">
						<span class="lm f_l"><a href="/">${posts.cats.catName}</a></span>
						<span class="dtime f_l">${posts.updatedAt}</span>
						<span class="viewnum f_r">浏览（<a href="/">${posts.post_extends.browser}</a>）</span>
						<span class="pingl f_r">评论（<a href="/comment/${posts.id}">${posts.post_extends.comment}</a>）
						</span>
					</p>
				</ul>
			</div>
