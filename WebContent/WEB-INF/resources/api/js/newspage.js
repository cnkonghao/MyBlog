...
$(document).ready(function() {
	...
	$("p").each(function(){
		if(wcount>800 && needHide==false){
			needHide = true;
			$('#content').after("<div onclick='showHiddens();' hidefocus='true' id='expanda' style='text-align:center;margin:30px 0;padding:6px 0'><img style='vertical-align:middle' src='http://zhbj.qianlong.com/images/expand.png' /><span style='vertical-align:middle'>&nbsp;点击展开全文</span></div>");
		}
